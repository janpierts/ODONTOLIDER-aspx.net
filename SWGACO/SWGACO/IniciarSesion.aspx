<%@ Page Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="IniciarSesion.aspx.cs" Inherits="SWGACO.IniciarSesion" %>
            ...
            <div class="card">
                <div class="card-body">
                    <fieldset class="border" style="width: 80%; margin-left: 160px" >
                        <legend class="hdrText"><i class="fa fa-user"></i>  LOGIN</legend>
                        <div class="col-sm-3 col-md-6">
                            <section style="margin-left: 470px">
                                <div>
                                ...
                                <br />
                                <a href="CambiarPassword.aspx">Cambiar contraseña</a>
                            </section>
                        </div>
                    </fieldset>
                </div>
