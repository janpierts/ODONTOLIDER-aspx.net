<%@ Page Title="" Language="C#" MasterPageFile="~/Paciente/PacienteHome.Master" AutoEventWireup="true" CodeBehind="ListarPCitas.aspx.cs" Inherits="SWGACO.ListarPCitas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-align: right mt-1" style="padding: 20px;">
        ...
        <button type="button" class="btn waves-effect waves-light btn-success hidden-md-down text-white" onclick="location.href='AdministrarCitas.aspx'">
                ...
                <asp:GridView ID="gv_Tabla_Lista_Cita" runat="server" OnRowCommand="gv_Tabla_Lista_Cita_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Cita_PageIndexChanging" EmptyDataText="No hay Solicitudes aceptadas" CssClass="table-responsive-sm table-hover" Width="100%" AutoGenerateColumns="False" GridLines="None" OnDataBound="gv_Tabla_Lista_Cita_DataBound" OnRowDataBound="gv_Tabla_Lista_Cita_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                 <asp:LinkButton ID="LinkButton2" Height="38px" CssClass="btn btn-danger" runat="server" CommandName="Cancelar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Editar" Style="color: white">
                                         Cancelar             
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
