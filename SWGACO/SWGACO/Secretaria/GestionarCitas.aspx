<%@ Page Title="" Language="C#" MasterPageFile="~/Secretaria/SecretariaHome.Master" AutoEventWireup="true" CodeBehind="GestionarCitas.aspx.cs" Inherits="SWGACO.Secretaria.GestionarCitas" %>
                    ...
                    <fieldset class="border" style="width: 80%; margin-left: 160px">
                        ...
                        <div class="col-sm-3 col-md-6">
                            <section style="margin-left: 170px">
                                ...
                                <br />
                                <asp:TextBox ID="txtBuscar" onkeypress="javascript:return SoloNumeros(event)"  runat="server" type="text" Style="border-radius: 25px; margin-left: -100px; padding-left: 40px; padding-right: 40px;"></asp:TextBox>
                                <span id="icon" style="margin-left: -270px">
                                    <i class="fa fa-search" aria-hidden="true"></i>
                                 </span>

                                 <br />
                                 <br />
                                  <asp:LinkButton ID="btnBuscar" CssClass="btn btn-info" runat="server" Text="Buscar" OnClick="btnBuscar_Click"><i class="fa fa-search" aria-hidden="true"></i>
                                                        <p5 style="color:white">Buscar</p5>
                            </asp:LinkButton>
                            </section>
                        </div>

                        <div class="col-sm-9 col-md-6" style="margin-left: 480px; margin-top: -140px">
                        ...
                        <div class="col-sm-3 col-md-6" style="margin-left: 780px; margin-top: -260px">
