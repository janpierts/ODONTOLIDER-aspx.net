<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorHome.Master" AutoEventWireup="true" CodeBehind="RegistrarPropuesta.aspx.cs" Inherits="SWGACO.Doctor.RegistrarPropuesta" %>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <fieldset class="border" style="width: 80%; margin-left: 160px">
                        <legend class="hdrText"><i class="fa fa-user"></i>PROPONER TRATAMIENTO</legend>
                        ...
                        <div class="col-sm-9 col-md-6" style="margin-left: 300px; margin-top: -85px">
                            ...
                            <div class="form-group">
                                ...
                                <br />
                                <asp:TextBox ID="txtCantidad" runat="server" class="form-control" Width="30%" onkeypress="javascript:return SoloNumeros(event) "></asp:TextBox>
                        ...
                        <div class="col-sm-9 col-md-6" style="margin-left: 1000px; margin-top: 75px">
                            ...
                            <div class="form-group">
                                <asp:LinkButton ID="btnAgregar" CssClass="btn btn-info" runat="server" OnClick="btnAgregar_Click" Text="Agregar"> <span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color:white;"></span>
                                                        <p5 style="color:white">Agregar</p5>
                                </asp:LinkButton>
                            </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="btnEliminar" Height="38px" CssClass="btn btn-danger" runat="server" CommandName="Eliminar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Eliminar" Style="color: white">
                                         Eliminar            
                                            </asp:LinkButton>
                        ...
                        <div class="col-sm-9 col-md-6" style="margin-left: 1000px; margin-top: 75px">
                            ...
                            <div class="form-group">
                                <asp:LinkButton ID="btnGuardar" CssClass="btn btn-info" runat="server" OnClick="btnGuardar_Click" Text="Guardar"> <span class="glyphicon glyphicon-pencil" aria-hidden="true" style="color:white;"></span>
