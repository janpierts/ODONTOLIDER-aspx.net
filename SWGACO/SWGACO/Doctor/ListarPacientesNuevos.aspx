<%@ Page Title="" Language="C#" MasterPageFile="~/Doctor/DoctorHome.Master" AutoEventWireup="true" CodeBehind="ListarPacientesNuevos.aspx.cs" Inherits="SWGACO.Doctor.ListarPacientesNuevos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        function Search_Gridview(strKey) {
            ...
            var tblData = document.getElementById("<%=gv_Tabla_Lista_Paciente_Nuevo.ClientID %>");
            var rowData;
    ...
    <div class="row" style="padding-left:20px">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Listado de Pacientes Nuevos</h4>
                    <h6 class="card-subtitle"><code>Listado de Pacientes</code></h6>
           ...
           <asp:Label ID="txtCodHistoria" runat="server" Text="" Visible="false"></asp:Label>
                ...
                <asp:GridView ID="gv_Tabla_Lista_Paciente_Nuevo" runat="server" OnRowCommand="gv_Tabla_Lista_Paciente_Nuevo_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Paciente_Nuevo_PageIndexChanging" EmptyDataText="No hay Solicitudes aceptadas" CssClass="table-responsive-sm table-hover" Width="100%" AutoGenerateColumns="False" GridLines="None" OnDataBound="gv_Tabla_Lista_Paciente_Nuevo_DataBound" OnRowDataBound="gv_Tabla_Lista_Paciente_Nuevo_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                 ...
                                 <asp:LinkButton ID="btnRegistrarHistoria" Height="38px" CssClass="btn btn-primary" runat="server" CommandName="Historia" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Historia" Style="color: white">
                                         Registrar Historia             
                                </asp:LinkButton>
