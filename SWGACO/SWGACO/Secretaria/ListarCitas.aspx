<%@ Page Title="" Language="C#" MasterPageFile="~/Secretaria/SecretariaHome.Master" AutoEventWireup="true" CodeBehind="ListarCitas.aspx.cs" Inherits="SWGACO.ListarCitas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="text-align: right mt-1" style="padding: 20px;">
        ...
        <button type="button" class="btn waves-effect waves-light btn-success hidden-md-down text-white" onclick="location.href='GestionarCitas.aspx'">
            <i class="fa fa-book" aria-hidden="true" style="color: black;"></i>   Registrar Cita
        </button>
    </div>
                ...
                <asp:GridView ID="gv_Tabla_Lista_Cita" runat="server" OnRowCommand="gv_Tabla_Lista_Cita_RowCommand" OnPageIndexChanging="gv_Tabla_Lista_Cita_PageIndexChanging" EmptyDataText="No hay Solicitudes aceptadas" CssClass="table-responsive-sm table-hover" Width="100%" AutoGenerateColumns="False" GridLines="None" OnDataBound="gv_Tabla_Lista_Cita_DataBound" OnRowDataBound="gv_Tabla_Lista_Cita_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Acción" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnPagar" Height="38px" CssClass="btn btn-success" runat="server" CommandName="Pagar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Pagar" Style="color: white">
                                         Pagar             
                                </asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton1" Height="38px" CssClass="btn btn-primary" runat="server" CommandName="Editar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Editar" Style="color: white">
                                         Reprogramar             
                                </asp:LinkButton>
                                 <asp:LinkButton ID="LinkButton2" Height="38px" CssClass="btn btn-danger" runat="server" CommandName="Editar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" Text="Editar" Style="color: white">
                                         Cancelar             
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
